...
function($) {
  ...
  Datepicker.prototype = {
    ...
    hide: function(e) {
      ...
      if (e && e.currentTarget.value) this.setValue();
      this.element.trigger({
        type: 'hide',
        date: this.date
      });
    ...
    update: function() {
      ...
      this.isInput ? this.element.prop('value') : this.element.data('date'), this.format, this.language);
    ...
    parseDate: function(date, format, language) {
      ...
      if (parts.length == format.parts.length) {
        ...
        for (var i = 0, s; i < setters_order.length; i++) {
          s = setters_order[i];
          if (s in parsed) setters_map[s](date, parsed[s])
        }
      }
      return date;
    },
